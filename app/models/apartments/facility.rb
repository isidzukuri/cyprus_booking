class Facility < ActiveRecord::Base
 ...
 # validates :name_ru, :name_en,   :presence => {:message=>I18n.t("facilities.errors.presense")}, :length => {:minimum => 3, :maximum => 254 ,:message=>I18n.t("facilities.errors.minimum_chars")}
