...
$(document).ready(function(){
    ...
    $.validator.addMethod("valid_bonus_card", function(value, element){
        index = $(element).attr('id').replace('bonus_card_', '');
        return !($('#bbox' + index).next().hasClass('jNiceChecked') && (value.length == 0))        
    ...
    $.validator.addMethod("date_valid", function(value, element){
        ...
        return (!/Invalid|NaN/.test(new Date( parseInt(year), parseInt(month), parseInt(day))));
